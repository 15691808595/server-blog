...
<div class="container col-sm-8 col-sm-offset-2">
    ...
    <form action="" method="post" class="form-horizontal">
		     ...
		     <!-- 文章分类-->
                    ...
                    <div class="form-group">
                        <div class="col-sm-1">
                            <input type="text" class="form-control" name="id" disabled  placeholder="原文的id" value="{$row['id']}">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="user" disabled placeholder="原文的user" value="{$row['user']}">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="createTime" disabled placeholder="原文的createTime" value="{$row['createTime']}">
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="img" disabled placeholder="原文的img" value="{$row['img']}">
                        </div>
                    </div>
                    <!--文章内容在线编辑器-->
                    <div class="form-group">
